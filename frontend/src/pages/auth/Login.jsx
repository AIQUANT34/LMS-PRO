    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-slate-50 p-6">
            <div className="w-full max-w-4xl grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
                <div className="hidden md:flex flex-col justify-center rounded-l-2xl bg-gradient-to-b from-indigo-700 to-indigo-500 p-10 text-white shadow-lg" style={{overflow:'hidden'}}>
                    <img src={logo} alt="logo" className="mb-6" style={{width:90, height:100, maxWidth:'100%', objectFit:'contain'}} />
                ...
                <div className="bg-white rounded-2xl shadow p-8 md:p-10">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div>
                            ...
                            <div className="mt-1 relative rounded-md shadow-sm">
                                <input
                                    ...
                                    className={`block w-full rounded-lg border border-gray-200 px-4 py-2 text-sm placeholder-gray-400 shadow-sm transition focus:outline-none focus:ring-2 focus:ring-indigo-300 focus:border-indigo-300 ${errors.email ? 'border-red-400' : ''}`}
                                    style={{fontSize:16}}
                        ...
                        <div>
                            ...
                            <div className="mt-1 relative rounded-md shadow-sm">
                                <input
                                    ...
                                    className={`block w-full rounded-lg border border-gray-200 px-4 py-2 text-sm placeholder-gray-400 shadow-sm transition focus:outline-none focus:ring-2 focus:ring-indigo-300 focus:border-indigo-300 ${errors.password ? 'border-red-400' : ''}`}
                                    style={{fontSize:16}}
                        ...
                        <div>
                            <button
                                type="submit"
                                className="w-full inline-flex justify-center items-center gap-2 rounded-md bg-indigo-600 text-white px-4 py-2 text-sm font-medium hover:bg-indigo-700 disabled:opacity-60"
                                disabled={loading}
                            >
                                {loading && (
